...
// sử dụng để cấu hình cơ sở dữ liệu trong kiểm thử và
// thuộc tính replace = AutoConfigureTestDatabase.Replace.NONE chỉ định rằng
// không có thay đổi nào sẽ được áp dụng cho cấu hình cơ sở dữ liệu gốc khi chạy kiểm thử.
public class EmployeeRespositorySQLTests {
